...
export declare const Icon: ExtendedVue<Vue_2<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => Vue_2<Record<string, any>, Record<string, any>, never, never, any>>, {
    iconMounted: boolean;
}, {
    abortLoading(): void;
    getIcon(icon: IconifyIcon | string, onload?: IconifyIconOnLoad): IconComponentData | null;
}, unknown, Record<never, any>, {}, ComponentOptionsMixin, ComponentOptionsMixin>;
